...
**Briefing:** title card with level name, objective, time limit and avaiable powerups. "TAP TO START" indicator. Stays on screen until the player taps, then fades into gameplay.
...
## Stretch by order of importants (only if ahead by day 20)
